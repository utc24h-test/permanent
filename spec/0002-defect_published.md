...
On **13 September 2026**, between 08:47 and 09:58 UTC, GitHub rejected thirteen writes from this
...
In five of those turns the file went through after retrying. **In the 09:00 turn it did not**:
...
3. **The 09:00 report was published without the attempt log**, even though `attempts` is declared in
   this specification and the other five do carry it. The reason: that report was written by the
...
- The reports for the 08:50, 09:10, 09:30 and 10:00 turns carry, signed, the time and response code
  of every attempt. They match the incident GitHub declared that day between 09:16 and 10:44 UTC.
