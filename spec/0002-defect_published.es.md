...
El **13 de septiembre de 2026**, entre las 08:47 y las 09:58 UTC, GitHub rechazó trece escrituras
...
En cinco de esos turnos el archivo entró tras reintentar. **En el turno de las 09:00 no entró**:
...
3. **El parte del turno 09:00 se publicó sin la bitácora de intentos**, aunque `attempts` está
   declarado en esta especificación y los otros cinco sí la llevan. El motivo: ese parte lo escribió
...
- Los partes de los turnos 08:50, 09:10, 09:30 y 10:00 llevan adentro, firmados, la hora y el código
  de respuesta de cada intento. Contrastan con el incidente que GitHub declaró ese día entre las
